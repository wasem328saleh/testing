...
class Classification extends Model
{
    ...
    {
        return $this->hasMany(ConfigAttribute::class, 'classification_id','id');
    }

    public function orders()
    {
        return $this->hasMany(Order::class, 'classification_id','id');
    }

    public function advertisements()
    {
        return $this->hasMany(Advertisement::class, 'classification_id','id');
    }

    public function features()
    {
        return $this->hasMany(Feature::class, 'classification_id','id');
    }
