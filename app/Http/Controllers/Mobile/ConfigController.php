...
use App\Http\Requests\Mobile\Config\ConfigRequest;
use App\Repositories\Mobile\Config\ConfigMobileDeveloperRepositoryInterface;
use Illuminate\Http\Request;

class ConfigController extends Controller
{
    protected ConfigMobileDeveloperRepositoryInterface $config;

    /**
     * @param ConfigMobileDeveloperRepositoryInterface $config
     */
    public function __construct(ConfigMobileDeveloperRepositoryInterface $config)
    {
        $this->config = $config;
    }
