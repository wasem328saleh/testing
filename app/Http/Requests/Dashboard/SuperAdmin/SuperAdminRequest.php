...
class SuperAdminRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if (Str::contains($path,'admin/add'))
        {
            return [
...
//                'device_uuid'=>['required','string','unique:security_settings'],
        ...
        if (Str::contains($path,'user/edite')){
            return [
        ...
        if (Str::contains($path,'user/delete')){
            return [
                'user_id'=>['required','exists:users,id'],
            ];
        }
        if (Str::contains($path,'user/change-status')){
            return [
                'user_id'=>['required','exists:users,id'],
            ];
        }
        if (Str::contains($path,'user/change-role')){
            return [
                'user_id'=>['required','exists:users,id'],
        ...
        if (Str::contains($path,'role/update-permissions')){
            return [
                'role_id'=>['required','exists:roles,id'],
